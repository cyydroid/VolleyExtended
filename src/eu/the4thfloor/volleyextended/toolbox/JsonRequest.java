...
public abstract class JsonRequest<T> extends Request<T> {
   ...
   */
  @Deprecated
  public JsonRequest(final String url, final String requestBody, final Listener<T> listener, final ErrorListener<T> errorListener) {

    this(Method.DEPRECATED_GET_OR_POST, url, requestBody, listener, errorListener);
  }

  public JsonRequest(final int method, final String url, final String requestBody, final Listener<T> listener, final ErrorListener<T> errorListener) {
  ...
  @Override
  protected void deliverResponse(final T response, final boolean hasChanged) {
