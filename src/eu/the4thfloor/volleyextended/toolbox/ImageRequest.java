...
import eu.the4thfloor.volleyextended.DefaultRetryPolicy;
import eu.the4thfloor.volleyextended.NetworkResponse;
import eu.the4thfloor.volleyextended.ParseError;
import eu.the4thfloor.volleyextended.Request;
import eu.the4thfloor.volleyextended.Response;
...
public class ImageRequest extends Request<Bitmap> {
  ...
  public ImageRequest(final String url,
                      ...
                      final Response.ErrorListener<Bitmap> errorListener) {
   ...
   */
  private static int getResizedDimension(final int maxPrimary, final int maxSecondary, final int actualPrimary, final int actualSecondary) {
  ...
  @Override
  protected Response<Bitmap> parseNetworkResponse(final NetworkResponse response) {
   ...
   */
  private Response<Bitmap> doParse(final NetworkResponse response) {
    ...
    if ((this.mMaxWidth == 0) && (this.mMaxHeight == 0)) {
      ...
      final int desiredWidth = getResizedDimension(this.mMaxWidth, this.mMaxHeight, actualWidth, actualHeight);
      final int desiredHeight = getResizedDimension(this.mMaxHeight, this.mMaxWidth, actualHeight, actualWidth);
  ...
  @Override
  protected void deliverResponse(final Bitmap response, final boolean hasChanged) {

    this.mListener.onResponse(response, hasChanged);
  }
   ...
   */
  // Visible for testing.
  static int findBestSampleSize(final int actualWidth, final int actualHeight, final int desiredWidth, final int desiredHeight) {
