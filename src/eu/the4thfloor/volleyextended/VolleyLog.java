...
public class VolleyLog {
  ...
  public static void e(final Throwable tr, final String format, final Object... args) {

    Log.e(TAG, buildMessage(format, args), tr);
  }

  public static void wtf(final String format, final Object... args) {

    Log.wtf(TAG, buildMessage(format, args));
  }

  public static void wtf(final Throwable tr, final String format, final Object... args) {
   ...
   */
  private static String buildMessage(final String format, final Object... args) {
  ...
  static class MarkerLog {
    ...
    private long getTotalDuration() {
      ...
      final long first = this.mMarkers.get(0).time;
      final long last = this.mMarkers.get(this.mMarkers.size() - 1).time;
      return last - first;
    }
  }
}
